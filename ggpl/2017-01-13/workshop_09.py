...
def ggpl_geometric_building_roof(segment_list,quote):
    """
...
def generate_terrace(internal_points,list_segment_angle):
    ...
    if(bool == 1):
        ...
        return STRUCT([TEXTURE("images/terrazza.jpg")((OFFSET([0.2,0.2,0.13])(MKPOL([internal_points,[list2],[1]]))))])
    ...
    while(i<len(list)):
        ...
        terrace.append(TEXTURE("images/terrazza.jpg")(OFFSET([0.2,0.2,0.13])(MKPOL([ [ list[i][0],list[i][1],list[i-1][0],list[i-1][1]],[[1,2,3,4]],[1]]))))
        i=i+1
    terrace.append(TEXTURE("images/terrazza.jpg")(OFFSET([0.2,0.2,0.013])(MKPOL([[list[0][0],list[0][1],list[len(list)-1][0],list[len(list)-1][1]],[[1,2,3,4]],[1]]))))
...
def generate_planes(segment_list, internal_points_list):
    ...
    while(i<len(segment_list)):
        ...
        list.append(TEXTURE("images/tetto.jpg")(OFFSET([0.1,0.1,0.1])(MKPOL([[segment_list[i][0],segment_list[i][1],internal_points_list[i-1],internal_points_list[i] ],[[1,2,3,4]],[1]]))))

        i=i+1

    list.append(TEXTURE("images/tetto.jpg")(OFFSET([0.1,0.1,0.1])(MKPOL([[segment_list[0][0],segment_list[0][1],internal_points_list[0],internal_points_list[len(internal_points_list)-1] ],[[1,2,3,4]],[1]]))))
